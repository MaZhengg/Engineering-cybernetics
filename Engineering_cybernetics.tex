...
% LaTeX source for book ``工程控制论'' in Chinese
% Copyright 钱学森.
...
%----------------------------------------------------------
%俄文字体设置 指令采用\rufont{Это русский текст в Times New Roman}
\usepackage[normalem]{ulem} % normalem 选项保持默认强调方式不变
\newfontfamily\russianfont{Times New Roman}  % 俄文特殊字体
\newcommand{\rufont}[1]{{\russianfont #1}}
%----------------------------------------------------------

\usepackage{booktabs} % 加粗表格线效果

\usepackage{enumitem} %自定义编号列表
